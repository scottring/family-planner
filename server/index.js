...
console.log('[Server] Planning session routes loaded:', typeof planningSessionRoutes);
...
console.log('[Server] Registering planning session routes at /api/planning-session');
